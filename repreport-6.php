            ...
            <div>
                    ...
                    <script>
                        ...
                        $("#condet").submit(function(e){
                            ...
                            $.ajax({ 
                                ...
                                cache: false,
                                success: function(showRes) {
                                    $('#resConDet').html('<i>'+dataString+'<br>'+showRes+'</i>');
                ...
                <section id="divlocdet" style="display:none">
                    ...
                    <form id="locdet">
                        ...
                        //}
                        //else {
                        //    echo '<input type="hidden" readonly id="mainlat" value="">';
                        //    echo '<input type="hidden" readonly id="mainlon" value="">';
                        //    echo '<input type="hidden" readonly id="distfm" value="">';
                        //}
                        ?>
                        <div id="forcoordupd">
                            <label>Use Client's Main Coordinates?*</label><br>
                            <input type="radio" id="tomaincoords" name="tomaincoords" value="yes" checked> Yes &emsp; <input type="radio" name="tomaincoords" value="no" required > No<br>
                        </div>
                        <br>
                        <div id="setthisasmaincoord" style="display:none">
                            <label>Set This As Client's Main Coordinates?*</label><br>
                            <input type="radio" id="newcpyloc" name="newcpyloc" value="yes"> Yes &emsp; <input type="radio" name="newcpyloc" value="no" required checked> No<br>
                        </div>
                        <div id="setmaincoordreqacc">
                            <label>Set This As Client's Main Coordinates?*</label>
                            <span>(Require 50m Accuracy)</span>
                        </div>
