...
if ( empty($branch) ){
	...
	?>
        ...
        <form class="" action="repconfirm.php" method="post">
            <?php if(!empty($cpyid)){ echo '<input type="hidden" id="cmpyid" name="cmpyid" value="'.$cpyid.'" >'; } ?>
			...
			<section id="divcpydet">
				<input type="hidden" name="compni" <?php if( isset($company) && !empty($company) ){ echo 'value="'.$company.'"'; } ?> autocomplete="off" autocapitalize=off required ></p>

				<label>Physical Province:*</label><br>
				<select id="provin" name="provin" onchange="getValue('provin')" required>
				...
				<label>Hub Area:*</label><br><input type="text" id="hubare" name="hubare" onmouseleave="getValue('hubare')" required value="<?php if(!empty($hub_area)){ echo $hub_area; } ?>" >
				...
				<label>Physical Town:*</label><br><input id="ptownl" name="ptownl" onmouseleave="getValue('ptownl')" type="text" required value="<?php if(!empty($pa_town)){ echo $pa_town; } ?>" >

				<label>Physical Street Address:*</label><br><input id="pstree" name="pstree" onmouseleave="getValue('pstree')" type="text" rows="3" cols="28" rows="5" required value="<?php if(!empty($pa_street)){ echo $pa_street; } ?>" >

				<p>Client Rating:*
					<select id="rating" name="rating" onchange="getValue('rating')" required>
			...
			<section>
				...
				if ( $qry = mysqli_query($dbcon,$sql) ){
					...
					if ( $num > 0 ){
                        ?>
					    <p>Select Contact:*<select id="contac" name="contac" onchange="getValue('contac')" required>
			...
			<section>
				<div>Vehicles In Fleet:*
					...
					?>
					<p><input type="number" id="vehm01" name="vehm01" value="<?php vehQty($cpyid,"1"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm01')"> Volvo</p>
					<p><input type="number" id="vehm02" name="vehm02" value="<?php vehQty($cpyid,"2"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm02')"> Scania</p>
					<p><input type="number" id="vehm03" name="vehm03" value="<?php vehQty($cpyid,"3"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm03')"> Mercedes</p>
					<p><input type="number" id="vehm04" name="vehm04" value="<?php vehQty($cpyid,"4"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm04')"> MAN</p>
					<p><input type="number" id="vehm06" name="vehm06" value="<?php vehQty($cpyid,"6"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm06')"> DAF</p>
					<hr>
					<p><input type="number" id="vehm20" name="vehm20" value="<?php vehQty($cpyid,"20"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm20')"> BPW</p>
					<p><input type="number" id="vehm22" name="vehm22" value="<?php vehQty($cpyid,"22"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm22')"> Henred</p>
					<p><input type="number" id="vehm30" name="vehm30" value="<?php vehQty($cpyid,"30"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm30')"> Afrit</p>
					<hr>
					<p><input type="number" id="vehm82" name="vehm82" value="<?php vehQty($cpyid,"82"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm82')"> Isuzu MCV</p>
					<p><input type="number" id="vehm80" name="vehm80" value="<?php vehQty($cpyid,"80"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm80')"> Hino</p>
					<p><input type="number" id="vehm81" name="vehm81" value="<?php vehQty($cpyid,"81"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm81')"> UD</p>
					<hr>
					<p><input type="number" id="vehm60" name="vehm60" value="<?php vehQty($cpyid,"60"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm60')"> Toyota</p>
					<p><input type="number" id="vehm61" name="vehm61" value="<?php vehQty($cpyid,"61"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm61')"> Ford</p>
					<p><input type="number" id="vehm63" name="vehm63" value="<?php vehQty($cpyid,"63"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm63')"> Isuzu LCV</p>
					<p><input type="number" id="vehm64" name="vehm64" value="<?php vehQty($cpyid,"64"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm64')"> Nissan</p>
					<p><input type="number" id="vehm71" name="vehm71" value="<?php vehQty($cpyid,"71"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm71')"> Mazda</p>
					<hr>
					<p><input type="number" id="vehm11" name="vehm11" value="<?php vehQty($cpyid,"11"); ?>" min="0" max="9999" maxlength="4" size="4" onmouseleave="getValue('vehm11')"> Sprinter</p>
					<hr>
					<p>Other Vehicles:<br>
					<?php
					...
					?>					
					<input type="text" id="vehotr" name="vehotr" <?php if ( !empty($vehotr) ){ echo 'value="'.$vehotr.'"'; } ?> onmouseleave="getValue('vehotr')"></p>
				</div>
			</section>
        ...
        <script>
			...
			function getValue(id){
                ...
                $.each(x, function(i, field) { 
					...
					window.alert(field.name + ":" + field.value + "<br>"); 
                }); 
				*/

				var thisCid = $('#cmpyid').val();
				//var thisNam = $('#'+id)..attr('name');
				var thisVal = $('#'+id).val();
				//window.alert(thisCid+', '+id+', '+thisVal);
				datastring = 'cid='+thisCid+'&field='+id+'&value='+thisVal;
				//window.alert(datastring);
				$.ajax({
					data: datastring,
					type: 'POST',
					url: 'repreport-update.php',
					success: function(response) {
						//$("#setl4").show();
						//$('#clientContactDetails').show().html(response);
						//$('#setAv').show();
						$('#infobox').text(response).css('display', 'block');
						/*setTimeout(function() {
							$('#infobox').animate({
								opacity: 0,
							}, 500, function(){
								$('#infobox').css('display', 'none').css('opacity', '1');
							});
						}, 500);*/
					},
