...
if ( empty($branch) ){
	...
	?>
		...
		$sql = "SELECT company_name,account_nr,physical_street,physical_town,physical_province,client_rating FROM clients_main WHERE id = '$cpyid' AND assigned_branch = '$branch' LIMIT 1;";
        ...
        <form class="" action="repconfirm.php" method="post">
			...
			<section>
				...
				<!-- province: make a dropdown -->
				<!--p>Physical Province:*<input name="provin" type="text" rows="3" cols="28" rows="5" placeholder="Clients physical town located" required value="<?php if(!empty($pa_prov)){ echo $pa_prov; } ?>" ></p-->
