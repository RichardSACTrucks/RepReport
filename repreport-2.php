...
if ( empty($branch) ){
	...
	?>
        ...
        <form class="" action="repconfirm.php" method="post">
			...
			<section id="divcpydet" style="display:none">
			...
			<section id="divcondet" style="display:none">
				...
				if ( $qry = mysqli_query($dbcon,$sql) ){
					...
					if ( $num > 0 ){
						...
						?>
						<div id="newcontact">
							<p><!--style="display:none"-->Contact Name:*<input id="contactname" name="newcontac" type="text" placeholder="Clients Name" required></p>
							<p>
			...
			<section id="divvehicl" style="display:none">
			...
			<section id="divvisnot" style="display:none">
				...
				?-->
				<p>Happy With Service?* <input type="radio" class="happyc" name="happyc" value="yes"> Yes &emsp; <input type="radio" class="happyc" name="happyc" value="no" required > No</p>
				...
				<p>My Notes:*<textarea id="rnotes" name="rnotes" type="text" rows="3" cols="28" rows="5" maxlength="255" placeholder="My notes about the visit" required><?php if ( !empty($cmment) ){ echo $cmment; } ?></textarea></p>
		...
		<div>
			...
			if ( $previsits == "yes"){
				...
				if ( $num3 > 0 ){
                    echo '<h2 id="prevvisi">PREVIOUS VISITS</h2>';
					echo '<section id="divprevis" style="display:none">';
        ...
        <script>
			...
			*/
			...
			// this is to change the colour of the h2 when all fields are filled in the section
			$('#contactSelect').change(function(){
                var conthave = $('#contactSelect').val();
				$('#contdets').css("background-color", "#2eb82e");
            });
			/* die een wil nog nie werk nie
			//$(document).ready(function(){
			if ( $('.happyc').val()  && $('#rnotes').val() ){
				$('#visinote').css("background-color", "#2eb82e");
			}
			//});
			*/
/*
